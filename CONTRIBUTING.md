<!-- Canonical CONTRIBUTING for every *kit. Copy verbatim, then replace fundskit. -->
# Contributing

Thanks for your interest in fundskit. Bug reports, fixes, and small improvements are welcome.
