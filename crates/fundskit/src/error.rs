//! Unified error type for fundskit. All public methods return `fundskit::Result<T>`.
use thiserror::Error;
...
mod tests {
    ...
    fn checksum_mismatch_displays_both_digests() {
        let e = Error::ChecksumMismatch {
            file: "fund13f-2024Q1.parquet".into(),
            expected: "aaa".into(),
            actual: "bbb".into(),
        };
        let s = e.to_string();
        assert!(s.contains("aaa") && s.contains("bbb") && s.contains("fund13f-2024Q1.parquet"));
    }
}
